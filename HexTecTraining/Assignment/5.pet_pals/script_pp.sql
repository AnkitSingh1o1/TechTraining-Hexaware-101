...
select ae.event_name, count(*) as total_participants, shelter_location
from participants p
...
select s.shelter_name, count(*) as Adoption_Available
from shelters s
...
left join pets p on p.shelter_id = s.shelter_id;
/* output
'1','Dog Shelter','Chennai','1','Dogeshwar','5','Labra','Dog','1','1'
'2','Cat Shelter','Bhopal','2','Kitten','2','Dontknow','Cat','0','2'
'3','Lion Shelter','Delhi','3','Sher','10','Big Cats','Cat','1','3'
*/
